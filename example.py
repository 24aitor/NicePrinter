...
if __name__ == '__main__':
    ...
    print(table(users, '‖', '*'))
    print(title("Colors"))
    print(red("My nice text"))
    print(center(yellow(bold(underline("My nice text")))))
    print()
    print(cbox(yellow(bold(underline("My nice text!"))), red("="), red("‖")))
    print(cbox(blue(bold(underline("My nice text!"))), purple("="), purple("‖")))
    print(cbox(red(bold(underline("My nice text!"))), cyan("="), cyan("‖")))
    print(title('Lists'))
